            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    <a href="/" class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-lg md:text-xl md:whitespace-nowrap font-bold text-gray-900 leading-tight">SNS College of Pharmacy <span class="text-primary-600">& Health Sciences</span></h1>
                        </div>
                    </a>
