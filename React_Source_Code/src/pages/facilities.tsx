...
export const FacilitiesPage = () => {
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            { img: '/static/images/4.Music Studio .jpg.jpeg', title: 'Music Studio', desc: 'Professional music studio with recording equipment and instruments for composition and creative expression.' },
            { img: '/static/images/3.Dance Studio .jpg.jpeg', title: 'Dance Studio', desc: 'Dedicated air-conditioned space for various dance styles—from classical to contemporary.' },
