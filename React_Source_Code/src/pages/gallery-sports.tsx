    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-3xl p-12 text-center shadow-2xl">
                ...
                <a href="/brochure-viewer/" target="_blank" class="bg-primary-600 hover:bg-primary-700 text-white px-12 py-5 rounded-2xl font-bold text-xl shadow-xl transition transform hover:scale-105 inline-flex items-center">
